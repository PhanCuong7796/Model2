...
?>
	...
	<head>
		...
		<title>Báo Cáo Chi Tiêu Theo Tháng</title>
		...
		<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
			<div class="row">
				<ol class="breadcrumb">
					...
					<li class="active">Chi Tiêu Theo Tháng</li>
				</ol>
			</div>
			<!--/.row-->
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">Báo Cáo Chi Tiêu Theo Tháng</div>
						<div class="panel-body">
							<div class="col-md-12">
								...
								?>
								<h5 align="center" style="color:blue">Số Liệu Chi Tiết Từ <?php echo $fdate ?> Đến <?php echo $tdate ?></h5>
								<hr />
