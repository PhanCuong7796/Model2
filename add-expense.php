...
if (strlen($_SESSION['detsuid'] == 0)) {
	...
	if (isset($_POST['submit'])) {
		...
		if ($query) {
			echo "<script>alert('Chi Tiêu Đã Được Thêm Vào');</script>";
		...
		<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
			<div class="row">
				<ol class="breadcrumb">
					...
					<li class="active">Thêm Chi Tiêu</li>
				</ol>
			</div>
			<!--/.row-->
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">Nhập Số Liệu</div>
