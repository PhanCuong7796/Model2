...
?>
	...
	<body>
		...
		<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
			...
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">Dữ Liệu Chi Tiết</h1>
				</div>
			</div>
			<!--/.row-->
			<div class="row">
				<div class="col-xs-6 col-md-3">
					<div class="panel panel-default">
						<div class="panel-body easypiechart-panel">
							...
							?>
							<h4>Chi Tiêu Hôm Nay</h4>
							<div class="easypiechart" id="easypiechart-blue" data-percent="<?php echo $sum_today_expense; ?>"><span class="percent">
				...
				<div class="col-xs-6 col-md-3">
					<div class="panel panel-default">
						...
						?>
						<div class="panel-body easypiechart-panel">
							<h4>Chi Tiêu Của Ngày Hôm Qua</h4>
				...
				<div class="col-xs-6 col-md-3">
					<div class="panel panel-default">
						...
						?>
						<div class="panel-body easypiechart-panel">
							<h4>Chi Tiêu Của 30 Ngày Qua</h4>
