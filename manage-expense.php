  <?php
	...
	if (strlen($_SESSION['detsuid'] == 0)) {
		...
		if (isset($_GET['delid'])) {
			...
			if ($query) {
				echo "<script>alert('Bản Ghi Đã Được Xóa Thành Công');</script>";
  			...
  			<div class="row">
  				<div class="col-lg-12">
  					<div class="panel panel-default">
  						<div class="panel-heading">Dữ Liệu Chi Tiêu</div>
											...
											?>
  											<tbody>
  												<tr>
  													...
  													<td><a href="manage-expense.php?delid=<?php echo $row['ID']; ?>">Xóa</a></td>
  												</tr>
  											<?php
												$cnt = $cnt + 1;
											} ?>
